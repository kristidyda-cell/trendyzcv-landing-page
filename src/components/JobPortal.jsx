      ...
      <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
        <div>
          ...
          <p className="text-gray-400 text-base sm:text-lg mt-6 leading-8">
            A professional job portal where candidates can search and apply for
            jobs, while employers can post requirements, collect CVs and manage
            applicants from a simple dashboard.
          </p>
        ...
        <div className="bg-white text-black rounded-3xl p-5 sm:p-6 w-full">
          <div className="flex flex-col sm:flex-row gap-3 mb-6">
            <input
              className="w-full flex-1 border border-gray-200 rounded-xl px-4 py-3"
              placeholder="Search job title"
            />

            <button className="w-full sm:w-auto bg-black text-white px-6 py-3 rounded-xl font-bold">
              Search
            </button>
          </div>
          ...
          {jobs.map((job, index) => (
            <div
              key={index}
              className="border border-gray-200 rounded-2xl p-5 mb-4 last:mb-0 hover:border-cyan-400 transition"
            >
